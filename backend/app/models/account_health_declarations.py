...
# db/tables/37_account_health_declarations.sql), minus the Project-only
# Treatment fields (Applicable Phase / Project Status).
class AccountHealthDeclaration(Base, UUIDPrimaryKey):
    __tablename__ = "account_health_declarations"
