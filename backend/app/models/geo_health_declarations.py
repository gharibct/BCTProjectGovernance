...
# Geo RAG Status — geo-level equivalent of AccountHealthDeclaration (see
# db/tables/38_geo_health_declarations.sql), same 6-category taxonomy.
class GeoHealthDeclaration(Base, UUIDPrimaryKey):
    __tablename__ = "geo_health_declarations"
