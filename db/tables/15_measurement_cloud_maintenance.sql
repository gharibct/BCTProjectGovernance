...
-- continuously, rolled up monthly (SLA-style availability reporting) via as_of_date.
...
CREATE INDEX idx_measurement_cloud_maintenance_project_id ON measurement_cloud_maintenance(project_id, as_of_date DESC);
