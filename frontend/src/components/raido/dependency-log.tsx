...
function toValues(item: DependencyLogItem): Record<string, string> {
  return {
    ...item,
...
export function DependencyLog() {
  ...
  const visibleItems = filterRaidoByStatus(items, "dependencies", "dependency_status", statusFilter);
  ...
  const busy = createDependency.isPending || updateDependency.isPending;
    ...
    <div className="flex flex-col gap-8">
      ...
      >
        ...
        <RegisterTable
          items={visibleItems}
          emptyLabel={
            items.length === 0 ? "No dependencies logged yet." : "No dependencies match this filter."
          }
          onEdit={startEdit}
